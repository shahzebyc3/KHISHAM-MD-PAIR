        ...
        sock.ev.on("connection.update", async (update) => {
            ...
            if (connection === "open") {
                ...
                try {
                    ...
                    const sessionId = "KHISHAM-MD-" + base64;

                    await sock.sendMessage(sock.user.id, { text: sessionId });

                    const successMsg = {
                        text:
                            `🚀 *KHISHAM-MD Session Created!*\n\n` +
                            `▸ *Never share* your session ID\n` +
                            `▸ Join our WhatsApp Channel\n` +
                            `▸ Report bugs on GitHub\n\n` +
                            `_Powered by KHISHAM-MD-\n\n` +
                            `🔗 *Useful Links:*\n` +
                            `▸ https://github.com/shahzebyc3/KHISHAM-MD-\n` +
                        ...
                        contextInfo: {
                            ...
                            forwardedNewsletterMessageInfo: {
                                newsletterJid: "120363244696862411@newsletter",
                                newsletterName: "KHISHAM-MD-",
                                serverMessageId: 143
                            }
                        }
                    };
